...
jQuery(document).ready(function($) {
  ...
  // show-hide block
  $(".block-2-sh__nav a").on("click", function(e) {
  ...
  function filterClick() {
    ...
    if (parent.hasClass("active") && !alm_is_animating) {
      return false;
    }
    alm_is_animating = true;
    var active = $(".alm-filter-nav li.active");
    if (active) {
  ...
  var filter_buttons = $(".alm-filter-nav li a");
  if (filter_buttons) {
  ...
  // toggle investment team/advisors
  $(".toggle a").on("click", function(e) {
    e.preventDefault();
    var selectedType = $(this).data("type");
    $(".text-desc").hide();
    $(".text-" + selectedType).show();
    $(this)
      .addClass("active")
      .siblings("a")
      .removeClass("active");
    $(".block-team .grid .person").each(function(i, obj) {
